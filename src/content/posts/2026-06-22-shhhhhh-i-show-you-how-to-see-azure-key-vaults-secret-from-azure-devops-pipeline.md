...
\* \[](https://www.koskila.net/how-to-output-the-value-of-a-secret-variable-in-azure-devops/)He also faced issue like me, and so found a solution (write to a file and read): <https://blog.robsewell.com/blog/when-you-really-want-to-see-your-azure-devops-secret-variable-values/>
...
But, if you can't fullfil the pre-requisite, then, these alternative approach will still help you debug your issue. 
